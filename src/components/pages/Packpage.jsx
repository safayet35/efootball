...
import rotateGif from "../../../public/assets/rotate.gif";
import boxData from "../../api/boxData";
    ...
    return (
        <div className="h-screen w-full">
            {isLandscape ? (
                    ...
                    <div className=" pb-6 px-10 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-10">
                            ...
                            <p className="font-font_sans text-white text-[10px]">
                                *The displayed Overall Ratings reflect the
                                highest
                                <br />
                ...
                <div className="h-screen flex items-center justify-center bg-gray-100 flex-col">
                    <img className="w-60" src={rotateGif} alt="" />
